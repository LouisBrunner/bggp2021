...
filehdr:
  ...
  dw 0          ; Compression method (STORE = 0, DEFLATE = 8)
  dw 15 | 21 << 4 | 20 << 10 ; File last modification time
  dw 30 | 4  << 4 | 13 <<  8 ; File last modification date
  dd 0x086e93bc ; CRC-32 of uncompressed data
  dd 1197       ; Compressed size (or 0xffffffff for ZIP64)
  dd 4          ; Uncompressed size (or 0xffffffff for ZIP64)
...
cdhdr:
  ...
  dw 30 | 4  << 4 | 13 <<  8 ; File last modification date
  dd 0x086e93bc ; CRC-32 of uncompressed data
  dd 4          ; Compressed size (or 0xffffffff for ZIP64)
  dd 4          ; Uncompressed size (or 0xffffffff for ZIP64)
